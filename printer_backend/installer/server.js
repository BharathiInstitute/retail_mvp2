...
// Determine data directory - use user's AppData for installed service, current dir otherwise
const IS_PACKAGED = process.pkg !== undefined;
const DATA_DIR = IS_PACKAGED 
  ? path.join(process.env.APPDATA || process.env.HOME || __dirname, 'RetailPOS-PrintHelper')
  : __dirname;
