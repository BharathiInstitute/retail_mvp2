					...
					return ListView(
						children: [
							...
							Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
								Expanded(flex: 3, child: Column(children: [revenueVsTarget, context.gapVMd, topProductsTable])),
								context.gapHMd,
								Expanded(flex: 2, child: Column(children: [paymentSplit, context.gapVMd, alertsTable, context.gapVMd, export, context.gapVXs, quickLinks])),
							]),
						],
					);
				}
			...
			Expanded(
				child: Align(
					alignment: Alignment.bottomCenter,
						child: Container(
							height: 120 * value,
								decoration: BoxDecoration(color: color.withOpacity(0.85), borderRadius: context.radiusSm),
							child: Center(
	...
	Widget build(BuildContext context) {
		...
		return InkWell(
			...
			child: Ink(
				...
				decoration: BoxDecoration(color: tone.surfaceContainerHighest, borderRadius: context.radiusSm, border: Border.all(color: tone.outlineVariant)),
