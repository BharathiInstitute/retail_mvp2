...
import '../../core/firestore_store_collections.dart' as scoped;
      ...
      child: Card(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Step 1: Pick File (.csv / .xlsx)', style: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.onSurface)),
              context.gapVMd,
              Text(pickedFileName == null ? 'No file selected yet' : 'Selected: $pickedFileName', style: TextStyle(color: Theme.of(context).colorScheme.onSurface)),
              context.gapVMd,
              FilledButton.icon(
                onPressed: _pickFile,
