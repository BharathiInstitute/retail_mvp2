  ...
  Future<void> _createProductFromItem(int index) async {
    ...
    final confirmed = await showDialog<bool>(context: context, builder: (_) => AlertDialog(
      ...
      content: DefaultTextStyle(style: (Theme.of(context).textTheme.bodyMedium ?? const TextStyle()).copyWith(color: Theme.of(context).colorScheme.onSurface), child: SizedBox(width: 420, child: Column(mainAxisSize: MainAxisSize.min, children:[
        ...
        context.gapVMd,
        Row(children:[
          const Text('Initial Qty:'), context.gapHSm,
        ...
        DataRow(cells: [
              ...
              if (st.match == null) ...[
                Tooltip(
                  ...
                  child: InkWell(
                    ...
                    child: Padding(padding: context.padXs, child: const Icon(Icons.add_circle_outline, size:16)),
                  ),
                ),
                Tooltip(
                  ...
                  child: InkWell(
                    ...
                    child: Padding(padding: context.padXs, child: const Icon(Icons.tips_and_updates, size:16)),
                  ),
                ),
              ] else ...[
                InkWell(
                  onTap: () => setState(() { st.match = null; st.confidence = null; st.locked = false; }),
                  child: Padding(padding: context.padXs, child: const Icon(Icons.clear, size:16)),
                ),
                InkWell(
                  onTap: () => setState(() { st.locked = !st.locked; }),
                  child: Padding(padding: context.padXs, child: Icon(st.locked ? Icons.lock : Icons.lock_open, size:16)),
                ),
              ]
            ])),
          )),
          ...
          DataCell(Row(children: [
            ...
            InkWell(
              ...
              child: Padding(padding: context.padXs, child: const Icon(Icons.edit, size:14)),
            )
          ])),
